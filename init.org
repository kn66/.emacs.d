...
#+begin_src emacs-lisp
  (use-package cape
    ...
    (add-hook 'message-mode-hook #'my/set-super-capf)
...
#+begin_src emacs-lisp
  (use-package nucleo-completion
    ...
    (setopt nucleo-completion-sort-ties-by-length nil
...
verticoをposframeを使用して表示するパッケージです。
...
*** [[https://github.com/kn66/vertico-posframe-preview][vertico-posframe-preview]]

vertico-posframeにプレビュー機能を追加するパッケージです。

#+begin_src emacs-lisp
  (use-package vertico-posframe-preview
    :vc ( :url "https://github.com/kn66/vertico-posframe-preview"
          :rev :newest)
    ;; :load-path "~/.emacs.d/lisp/vertico-posframe-preview/" ; 検証用
